...
void ProcessSnp(char **snp_lines, Individual *individuals, int n_of_individuals, char *population_id, VCFMap *vcf_map) {
    ...
    strcpy(fVName, "/home/bruno/Documentos/unifesp/tcc/arquivos/postgresNoSQL/variation_table_input.csv");
...
void ReadFile(char *fileName, VCFMap *vcf_map, Individual **individuals, char *population_id) {
    ...
    FILE *f = fopen("/home/bruno/Documentos/unifesp/tcc/arquivos/postgresNoSQL/individual_table_input.csv", "ab+");
...
int main(int argc, char *argv[]) {
  //HDRA-G6-4-RDP1-RDP2-NIAS.AGCT
    ...
    FILE *f = fopen("/home/bruno/Documentos/unifesp/tcc/arquivos/postgresNoSQL/population_table_input.csv", "ab+");
